...
\begin{itemize}
  ...
  \item 在公开数据集Conll-2014上达到SOAT的效果.
\end{itemize}
...
\textbf{文本风格转换任务}
\begin{itemize}
  \item 采用反向翻译，改写target端语句等方式进行数据增强实验;
  \item 将GPT2的单encoder结构改写成双encoder结构;
  \item 引入copyNet机制，以及加入Adapter层，用语言模型进行rerank等；
  \item 在公开数据集GYAFC上达到SOAT的效果，并产出论文一篇.
\end{itemize}

\datedsubsection{\textbf{科大讯飞} \qquad \textbf{哈工大讯飞联合实验室} \quad nlp算法实习生 }{2017.08 -- 2018.10}
\vspace{0.1cm}
